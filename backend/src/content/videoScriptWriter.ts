...
const VIDEO_SCRIPT_SCHEMA = {
  ...
  properties: {
    ...
    caption: { type: "string", description: "The platform caption/description text, separate from the spoken script." },
    hashtags: { type: "array", items: { type: "string" }, description: "Hashtags without the # prefix." },
  },
  required: ["hook", "script", "shotList", "caption", "hashtags"],
};
...
- caption: the platform caption text, separate from the spoken script.
- hashtags: relevant, not spammy -- no hashtag stuffing, no irrelevant trending tags.
