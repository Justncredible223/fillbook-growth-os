...
export const CHARACTER_BEATS: Record<string, CharacterBeat[]> = {
  "pilot-1-green-month-losing-setup": [
    ...
    beat("rook", "Your month, your breakdown.", "shrug", "think"),
  ...
  "pilot-2-balance-isnt-your-buffer": [
    ...
    beat("rook", "Your firm's rules win. Always.", "think", "shrug"),
  ...
  "pilot-3-same-setup-bigger-size": [
    ...
    beat("rook", "One trade. Your log will differ.", "shrug", "idle"),
  ...
  "pilot-4-best-day-blocks-payout": [
    ...
    beat("rook", "Every firm counts it differently.", "shrug", "think"),
  ...
  "pilot-5-would-you-pass": [
    ...
    beat("rook", "Check the firm's real rules.", "think", "idle"),
  ...
  "pilot-6-edge-score": [
    ...
    beat("rook", "Past trades, not a prophecy.", "shrug", "idle"),
  ...
  "pilot-7-daily-brief": [
    ...
    beat("rook", "Built from your own logs.", "shrug", "idle"),
  ...
  "pilot-8-red-weekday": [
    ...
    beat("rook", "Your weekdays will differ.", "shrug", "idle"),
  ...
  "pilot-9-payout-countdown": [
    ...
    beat("rook", "A projection, not a promise.", "shrug", "idle"),
  ...
  "pilot-10-sized-up-after-a-loss": [
    ...
    beat("rook", "A flag to review, not a verdict.", "think", "idle"),
  ...
  "pilot-11-six-trade-days": [
    ...
    beat("rook", "Your normal is what counts.", "shrug", "idle"),
  ...
  "pilot-12-the-11-oclock-trades": [
    ...
    beat("rook", "Your hours will split differently.", "shrug", "idle"),
  ...
  "pilot-13-what-moving-your-stop-costs": [
    ...
    beat("rook", "Tags only count what you mark.", "think", "idle"),
  ...
  "pilot-14-would-you-take-it-again": [
    ...
    beat("rook", "Your honest answers do the work.", "shrug", "idle"),
  ...
  "pilot-15-92-percent-on-plan": [
    ...
    beat("rook", "Your rules decide the score.", "shrug", "idle"),
  ...
  "pilot-16-win-rate-76-to-55": [
    ...
    beat("rook", "Compare to your own baseline.", "shrug", "idle"),
  ...
  "pilot-17-two-accounts-one-screen": [
    ...
    beat("rook", "Your firm sets the real limits.", "shrug", "idle"),
  ...
  "pilot-18-your-best-setup-by-the-numbers": [
    ...
    beat("rook", "Past patterns aren't promises.", "shrug", "idle"),
